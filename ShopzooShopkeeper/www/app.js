...
shopApp.controller('defaultController',['$scope', '$log', function($scope, $log){
    $scope.name = 'default';
}]);


shopApp.controller('loginController',['$scope', '$log', function($scope, $log){
    $scope.name = 'login';
}]);

shopApp.controller('signupController',['$scope', '$log', function($scope, $log){
    $scope.name = 'signup';
}]);
...
var Shopkeeper = function(firstname, lastname, address, email, password, contact){
...
function signupCustomer(){
    ...
    document.addEventListener("apiReady", function(){
        window.df.apis.dfmongo.createRecords({"table_name":"Shopkeeper", "body":obj}, function(response) {
...
function loginCustomer(){
    ...
    document.addEventListener("apiReady", function(){
        window.df.apis.dfmongo.getRecordsByFilter({"table_name":"Shopkeeper", "filter":"Email = "+loginid}, function(response) {
