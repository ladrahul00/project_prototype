...
//after login, you can make a call to the dfmongo service, if the current user has access
...
//A path variable simply gets tacked on to the endpoint, not as a query param.
    window.app.getTodos = function () {
        window.df.apis.dfmongo.getRecords({table_name: "Customer"}, function (response) {
...
//Insert a record
    window.app.addTodo = function () {
        ...
        window.df.apis.dfmongo.createRecords({"table_name":"Customer", "body":item}, function(response) {
...
//Delete a record
    window.app.deleteTodo = function () {
        ...
        window.df.apis.dfmongo.deleteRecords({"table_name":"Customer", "ids":id}, function(response) {
...
//Update a record
    window.app.updateTodo = function () {
        ...
        df.apis.dfmongo.updateRecords({"table_name":"Customer", "body":item}, function(response) {
